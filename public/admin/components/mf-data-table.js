...
export default {
    ...
    methods: {
        ...
        handleCurrentChange(val) {
            this.$emit('pagination-change', { pageNum: val, pageSize: this.pageSizeValue });
        },
        handleSizeChange(val) {
            this.$emit('pagination-change', { pageNum: this.currentPageValue, pageSize: val });
        },
        ...
        formatter(type, column, value, row) {
            switch (type) {
                ...
                case 'date':
                    return value ? moment(value).format(column.format || 'YYYY-MM-DD') : value;
                case 'datetime':
                    return value ? moment(value).format(column.format || 'YYYY-MM-DD HH:mm:ss') : value;
                case 'time':
                    return value ? moment(value).format(column.format || 'HH:mm:ss') : value;
                case 'image':
